...
- [ ] 研究版本是 `v3.56-strict`。
- [ ] 应用版本是 `3.56.20`，approved strategy version 仍是 `3.56.15`。
...
```bash
sha256sum okx-contract-signal-system-v3.56.20-final.zip
unzip okx-contract-signal-system-v3.56.20-final.zip -d /tmp/okx-signal-release

...
This note records the v3.56.3 runtime-cache integration acceptance boundary for release packages.
...
Packaging:
- Build with `py -3.12 scripts/build_release_zip.py --output C:\Users\26492\Desktop\okx-contract-signal-system-v3.56.3-runtime-cache-integrated-final.zip`.

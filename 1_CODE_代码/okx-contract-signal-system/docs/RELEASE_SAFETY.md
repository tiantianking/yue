...
- Package metadata, launcher display, and GUI display are synchronized to `3.56.22`; approved strategy identity remains `3.56.15`, and strict research identity remains `v3.56-strict`.
